...
// A pool of research prompts — a fresh handful is sampled on every visit.
...
export default function Page() {
  ...
  // Fresh selection of suggested questions on every mount.
  const exampleQuestions = useMemo(() => sampleQuestions(QUESTION_POOL, 6), []);
    ...
    <main className="min-h-screen pb-40">
      ...
      <header className="border-b border-gold/20 bg-parchment/40">
        <div className="mx-auto max-w-prose px-6 py-8 flex items-center gap-4">
          <Logo className="w-12 h-12 shrink-0 drop-shadow-sm econbot-rise" />
          <div className="flex-1">
            <div className="flex items-baseline gap-3 flex-wrap">
              <h1 className="font-serif text-4xl md:text-5xl text-navy leading-none tracking-tight econbot-rise econbot-rise-delay-1">
                EconBot
              </h1>
              <span className="font-sans text-[10px] uppercase tracking-[0.22em] text-gold font-semibold econbot-rise econbot-rise-delay-2">
                by ECES
              </span>
            </div>
            <p className="mt-2 text-sm md:text-[15px] text-ink/65 font-sans econbot-rise econbot-rise-delay-3">
